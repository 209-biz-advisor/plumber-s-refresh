...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Family-owned plumbers in Escalon, CA. 28+ years of expert plumbing repairs, water heaters, drain cleaning & emergency plumbing repairs across the Central Valley." },
          ...
          "@graph": [
            {
              ...
              description:
                "Family-owned plumbing company serving Escalon, Modesto, Manteca and the Central Valley since 1996. Water heater replacement, drain cleaning, leak detection, repipes and emergency plumbing repairs.",
              address: {
                "@type": "PostalAddress",
